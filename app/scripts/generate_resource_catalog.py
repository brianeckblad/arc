...
def _render(entries: list[dict]) -> str:
    lines = [
        ...
        "",
        "Generated by ``app/scripts/generate_resource_catalog.py`` from the pulled SCM OpenAPI specs.",
        "Each entry becomes a feature-gated generated command via ``app/commands/generated.py``.",
        "Regenerate with:",
        "    python app/scripts/generate_resource_catalog.py   (runs automatically on docsupdate)",
        '"""',
        "",
        "from __future__ import annotations",
        "",
    ...
    if check_only:
        if rendered != current:
            print("app/commands/resource_catalog.py is STALE — new uncovered SCM "
                  "endpoints found. Run: python app/scripts/generate_resource_catalog.py")
            return 1
