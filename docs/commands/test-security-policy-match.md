...
description: "Test which security rule a packet matches — test security-policy-match source <ip> destination <ip> [from <zone>] [to <zone>] [application <app>] [destination-port <n>]"
