...
Create a **anti-spyware-profile** object in the active SCM folder.
...
```text
configure
set anti-spyware-profile <name> [<type-or-field> <value>] [description <text>] [tag <name>]
```
...
Resource notes: spyware/C2 detection settings
...
arc:global # set anti-spyware-profile MyObject ...
  ✓ Anti-Spyware-Profile MyObject created (id: ...)
```

## Related commands

- `show anti-spyware-profile` — list anti-spyware-profile objects in the active folder
- `delete anti-spyware-profile <name>` — remove a anti-spyware-profile object
