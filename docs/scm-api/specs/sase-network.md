...
**Version:** 2.0.0  
**Source:** `openapi-specs/scm/config/sase/network/network-services.yaml`  
**Base URL:** `https://api.strata.paloaltonetworks.com/config/network/v1`  
**Endpoints:** 246  
**GitHub:** https://github.com/PaloAltoNetworks/pan.dev/blob/master/openapi-specs/scm/config/sase/network/network-services.yaml
