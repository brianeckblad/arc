...
**Version:** 2.0.0  
**Source:** `openapi-specs/scm/config/ngfw/device/device-settings.yaml`  
**Base URL:** `https://api.strata.paloaltonetworks.com/config/device/v1`  
**Endpoints:** 89  
**GitHub:** https://github.com/PaloAltoNetworks/pan.dev/blob/master/openapi-specs/scm/config/ngfw/device/device-settings.yaml
...
**Summary:** Get autoscale settings  
**Operation ID:** `GetAutoscaleSettings`  
**Tags:** Autoscale Settings  
**Container scope:** folder | snippet | device  
**Response codes:** 200, 400, 401, 403, 404, default

### `POST /autoscale`

**Summary:** Create autoscale settings  
**Operation ID:** `CreateAutoscaleSettings`  
**Tags:** Autoscale Settings  
**Container scope:** folder | snippet | device (in request body)  
**Body schema:** `autoscale`  
**Response codes:** 201, 400, 401, 403, 404, 409, default

### `PUT /autoscale`

**Summary:** Update autoscale settings  
**Operation ID:** `UpdateAutoscaleSettings`  
**Tags:** Autoscale Settings  
**Container scope:** folder | snippet | device (in request body)  
**Body schema:** `autoscale`  
...
**Summary:** Delete autoscale settings  
**Operation ID:** `DeleteAutoscaleSettings`  
**Tags:** Autoscale Settings  
**Container scope:** folder | snippet | device  
**Response codes:** 200, 400, 401, 403, 404, 409, default
...
### `GET /content-cloud-settings`

**Summary:** List Content Cloud settings  
**Operation ID:** `ListContentCloudSettings`  
**Tags:** Content Cloud Settings  
**Container scope:** folder | snippet | device  
**Response codes:** 200, 400, 401, 403, 404, default

### `POST /content-cloud-settings`

**Summary:** Create Content Cloud settings  
**Operation ID:** `CreateContentCloudSettings`  
**Tags:** Content Cloud Settings  
**Container scope:** folder | snippet | device (in request body)  
**Body schema:** `content-cloud-settings`  
**Response codes:** 201, 400, 401, 403, 404, 409, default

### `GET /content-cloud-settings/{id}`

**Summary:** Get existing Content Cloud settings  
**Operation ID:** `GetContentCloudSettingsByID`  
**Tags:** Content Cloud Settings  
**Response codes:** 200, 400, 401, 403, 404, default

### `PUT /content-cloud-settings/{id}`

**Summary:** Update Content Cloud settings  
**Operation ID:** `UpdateContentCloudSettingsByID`  
**Tags:** Content Cloud Settings  
**Container scope:** folder | snippet | device (in request body)  
**Body schema:** `content-cloud-settings`  
**Response codes:** 200, 400, 401, 403, 404, 409, default

### `DELETE /content-cloud-settings/{id}`

**Summary:** Delete Content Cloud settings  
**Operation ID:** `DeleteContentCloudSettingsByID`  
**Tags:** Content Cloud Settings  
**Response codes:** 200, 400, 401, 403, 404, 409, default

### `GET /device-context-segment-association`

**Summary:** List device context segment associations  
**Operation ID:** `ListDeviceContextSegmentAssociation`  
**Tags:** Device Context Segment Association  
**Query params:** name, offset, limit  
**Response codes:** 200, 400, 401, 403, 404, default

### `POST /device-context-segment-association`

**Summary:** Create a device context segment association  
**Operation ID:** `CreateDeviceContextSegmentAssociation`  
**Tags:** Device Context Segment Association  
**Container scope:** folder | snippet | device (in request body)  
**Body schema:** `device-context-segment-association`  
**Required fields:** `name`  
**Response codes:** 201, 400, 401, 403, 409, default

### `DELETE /device-context-segment-association`

**Summary:** Delete device context segment associations by name  
**Operation ID:** `DeleteDeviceContextSegmentAssociationByName`  
**Tags:** Device Context Segment Association  
**Query params:** name  
**Response codes:** 200, 400, 401, 403, 404, 409, default

### `GET /device-context-segment-association/{id}`

**Summary:** Get a device context segment association  
**Operation ID:** `GetDeviceContextSegmentAssociationByID`  
**Tags:** Device Context Segment Association  
**Response codes:** 200, 400, 401, 403, 404, default

### `PUT /device-context-segment-association/{id}`

**Summary:** Update a device context segment association  
**Operation ID:** `UpdateDeviceContextSegmentAssociationByID`  
**Tags:** Device Context Segment Association  
**Container scope:** folder | snippet | device (in request body)  
**Body schema:** `device-context-segment-association`  
**Required fields:** `name`  
...
**Summary:** Delete a device context segment association  
**Operation ID:** `DeleteDeviceContextSegmentAssociationByID`  
**Tags:** Device Context Segment Association  
**Response codes:** 200, 400, 401, 403, 404, 409, default
...
**Operation ID:** `GetHAConfiguration`  
...
**Operation ID:** `DeleteHAConfiguration`  
**Tags:** High Availability Configurations  
**Container scope:** device  
**Response codes:** 200, 400, 401, 403, 404, default

### `GET /ha-configurations-ports`

**Summary:** Autocomplete HA ports  
**Operation ID:** `AutocompleteHAPorts`  
**Tags:** High Availability Configurations  
**Query params:** device_id, interface_type, limit, offset  
**Response codes:** 200, 400, 401, 403, default

### `GET /ha-configurations-ip-addresses`

**Summary:** Autocomplete HA IP addresses  
**Operation ID:** `AutocompleteHAIPAddresses`  
**Tags:** High Availability Configurations  
**Query params:** device_id, interface_type, limit, offset  
**Response codes:** 200, 400, 401, 403, default

### `GET /ha-configurations-netmasks`

**Summary:** Autocomplete HA netmasks  
**Operation ID:** `AutocompleteHANetmasks`  
**Tags:** High Availability Configurations  
**Query params:** device_id, interface_type, limit, offset  
**Response codes:** 200, 400, 401, 403, default

### `GET /ha-configurations-gateways`

**Summary:** Autocomplete HA gateways  
**Operation ID:** `AutocompleteHAGateways`  
**Tags:** High Availability Configurations  
**Query params:** device_id, interface_type, limit, offset  
**Response codes:** 200, 400, 401, 403, default
