...
**Version:** 2.0.0  
**Source:** `openapi-specs/scm/config/ngfw/setup/config-setup-feb-v1.yaml`  
**Base URL:** `https://api.strata.paloaltonetworks.com/config/setup/v1`  
**Endpoints:** 47  
**GitHub:** https://github.com/PaloAltoNetworks/pan.dev/blob/master/openapi-specs/scm/config/ngfw/setup/config-setup-feb-v1.yaml
