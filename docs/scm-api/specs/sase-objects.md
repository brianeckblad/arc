...
**Version:** 2.0.0  
**Source:** `openapi-specs/scm/config/sase/objects/objects-june.yaml`  
**Base URL:** `https://api.strata.paloaltonetworks.com/config/objects/v1`  
**Endpoints:** 105  
**GitHub:** https://github.com/PaloAltoNetworks/pan.dev/blob/master/openapi-specs/scm/config/sase/objects/objects-june.yaml
