...
**Version:** 2.0.0  
**Source:** `openapi-specs/scm/config/cloudngfw/setup/device-onboarding/device-onboarding-updated.yaml`  
**Base URL:** `https://api.strata.paloaltonetworks.com/config/setup/device-onboarding/v1`  
**Endpoints:** 21  
**GitHub:** https://github.com/PaloAltoNetworks/pan.dev/blob/master/openapi-specs/scm/config/cloudngfw/setup/device-onboarding/device-onboarding-updated.yaml
