...
**Version:** 2.0.0  
**Source:** `openapi-specs/scm/config/sase/network configurations/network-services-R2-2026.yaml`  
**Base URL:** `https://api.strata.paloaltonetworks.com/config/network/v1`  
**Endpoints:** 246  
**GitHub:** https://github.com/PaloAltoNetworks/pan.dev/blob/master/openapi-specs/scm/config/sase/network configurations/network-services-R2-2026.yaml
