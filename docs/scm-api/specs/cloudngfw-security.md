...
**Version:** 2.0.0  
**Source:** `openapi-specs/scm/config/cloudngfw/security/security-services.yaml`  
**Base URL:** `https://api.strata.paloaltonetworks.com/config/security/v1`  
**Endpoints:** 113  
**GitHub:** https://github.com/PaloAltoNetworks/pan.dev/blob/master/openapi-specs/scm/config/cloudngfw/security/security-services.yaml
