...
Pulled on 2026-07-02 from `PaloAltoNetworks/pan.dev` (master).
...
| `tenancy` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/tenancy/TenantServiceGroup.yaml` |
| `iam-service-accounts` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/iam/ServiceAccounts.yaml` |
| `adnsr` | `https://api.strata.paloaltonetworks.com` | `openapi-specs/scm/config/adnsr/adnsr.yaml` |
| `cdug` | `n/a` | `openapi-specs/scm/config/cdug/cdug.yaml` |
| `ciedss` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/config/ciedss/CIE-DSS-R2.yaml` |
| `cloudngfw-identity` | `https://api.strata.paloaltonetworks.com/config/identity/v1` | `openapi-specs/scm/config/cloudngfw/identity/identity-services-march.yaml` |
| `cloudngfw-objects` | `https://api.strata.paloaltonetworks.com/config/objects/v1` | `openapi-specs/scm/config/cloudngfw/objects/objects-june.yaml` |
| `cloudngfw-operations` | `https://api.strata.paloaltonetworks.com/config/operations/v1` | `openapi-specs/scm/config/cloudngfw/operations/config-operations-march.yaml` |
| `cloudngfw-security` | `https://api.strata.paloaltonetworks.com/config/security/v1` | `openapi-specs/scm/config/cloudngfw/security/security-services.yaml` |
...
| `sase-network` | `https://api.strata.paloaltonetworks.com/config/network/v1` | `openapi-specs/scm/config/sase/network/network-services.yaml` |
| `sase-objects` | `https://api.strata.paloaltonetworks.com/config/objects/v1` | `openapi-specs/scm/config/sase/objects/objects-june.yaml` |
| `sase-operations` | `https://api.strata.paloaltonetworks.com/config/operations/v1` | `openapi-specs/scm/config/sase/operations/config-operations-march.yaml` |
| `sase-security` | `https://api.strata.paloaltonetworks.com/config/security/v1` | `openapi-specs/scm/config/sase/security/security-services-R2-2026.yaml` |
| `sase-setup` | `https://api.strata.paloaltonetworks.com/config/setup/v1` | `openapi-specs/scm/config/sase/setup/config-setup-feb-v1.yaml` |
| `sase-device-onboarding` | `https://api.strata.paloaltonetworks.com/config/setup/device-onboarding/v1` | `openapi-specs/scm/config/sase/setup/device-onboarding/device-onboarding-updated.yaml` |
| `iam-access-policies` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/iam/AccessPolicies.yaml` |
| `iam-custom-roles` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/iam/CustomRoles.yaml` |
| `iam-permission-sets` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/iam/PermissionSets.yaml` |
| `iam-permissions` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/iam/Permissions.yaml` |
| `iam-roles` | `https://api.sase.paloaltonetworks.com` | `openapi-specs/scm/iam/Roles.yaml` |
