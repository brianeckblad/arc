...
Usage::
    ...
    python dev/panosupdate.py            # refresh mirrors + CHANGES.md
    python dev/panosupdate.py --check    # report drift, write nothing
"""
...
def build_changes_markdown(
    ...
    lines = [
        ...
        "",
        f"> Generated by `dev/panosupdate.py` on {pulled_on}.",
