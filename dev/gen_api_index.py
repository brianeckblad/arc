...
Usage:
    python dev/gen_api_index.py          # writes dev/API_INDEX.md
    python dev/gen_api_index.py --check  # prints without writing
    python dev/gen_api_index.py --cat network  # one spec only
...
# Refreshed by running: python dev/gen_api_index.py
