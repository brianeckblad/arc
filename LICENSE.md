...
You may not use the Software for the benefit of any third party without prior written permission from the Licensor.

You may not use the Software to perform work for customers, clients, affiliates, subsidiaries, parent companies, vendors, partners, contractors, managed-service customers, consulting customers, or outside organizations.

You may not provide access to the Software, modified versions of the Software, or services based on the Software to any third party without prior written permission from the Licensor.

4. No Commercial Services

You may not use the Software, directly or indirectly, as part of any paid service, consulting engagement, managed service, migration service, firewall conversion service, implementation service, professional service, support service, training service, hosted service, assessment service, integration service, or other service provided in exchange for money, compensation, business advantage, contract value, customer retention, barter, or other consideration.

Only the Licensor may charge for access to, licensing of, support for, services related to, or commercial deployment of the Software.

5. Restricted Providers

Restricted Providers may not use, copy, modify, evaluate, benchmark, distribute, host, derive from, incorporate, adapt, commercialize, or provide services using the Software without prior written permission from the Licensor.

This restriction applies whether the use is internal, external, commercial, noncommercial, direct, indirect, experimental, developmental, educational, or evaluative.
...
7. No SaaS, Hosted Service, or Network Service Use

You may not host the Software, expose the Software over a network, provide access to the Software through an API, web interface, portal, automation platform, managed service, SaaS product, marketplace offering, or other hosted service for use by any third party.

You may not use the Software as the backend, engine, library, converter, orchestrator, policy compiler, configuration generator, migration engine, source-of-truth processor, object normalizer, rule processor, integration layer, or automation component of any hosted, commercial, managed, or third-party-facing service without prior written permission from the Licensor.

8. Modifications

You may modify the Software only for authorized Internal Use.

All modified versions remain subject to this License.

You may not distribute, publish, sell, sublicense, host, provide as a service, or otherwise make modified versions available to any third party without prior written permission from the Licensor.

9. No Public Forking or Public Redistribution

You may not publicly fork, publicly clone, publicly mirror, publicly archive, publicly publish, or publicly redistribute the Software or any portion of it without prior written permission from the Licensor.

Private cloning is permitted only where necessary for authorized Internal Use.

10. No Derivative or Competing Use

You may not copy, adapt, translate, incorporate, extract, or create derivative works from the Software, including its source code, documentation, schemas, object models, policy models, conversion logic, migration logic, workflows, interfaces, examples, tests, and other copyrightable materials, except as expressly permitted by this License.
...
By submitting, uploading, proposing, emailing, committing, pushing, discussing, documenting, filing, or otherwise providing any code, documentation, issue, pull request, patch, design, workflow, schema, example, suggestion, comment, test, configuration, bug report, feature request, or other contribution to the Software, you agree that your contribution does not grant you ownership, control, license rights, distribution rights, commercialization rights, approval rights, governance rights, or continuing permission to use the Software.

To the maximum extent permitted by law, you grant the Licensor a perpetual, irrevocable, worldwide, royalty-free, fully paid-up, transferable, sublicensable, and assignable license to use, reproduce, modify, adapt, publish, distribute, commercialize, sublicense, relicense, incorporate, create derivative works from, and otherwise exploit your contribution for any purpose, in any form, in any medium, under any license or business model, without compensation, notice, attribution, approval, or accounting.

You represent that you have the right to submit the contribution and that the contribution does not violate any contract, employment obligation, confidentiality obligation, intellectual property right, trade-secret right, export-control restriction, or third-party right.

The Licensor is not required to accept, use, publish, retain, respond to, credit, or compensate any contribution.

13. No Contributor Ownership

Contributors do not receive ownership of the Software, the repository, the project name, the roadmap, the license, the distribution model, or any commercial rights.

A contribution does not create a partnership, joint venture, employment relationship, agency relationship, fiduciary duty, shared ownership interest, or shared governance right.

A contribution does not create an implied license back to the contributor.
...
No rights are granted to any trademark, service mark, trade name, logo, project name, domain name, branding, or other identifier of the Licensor.

15. Confidentiality and Access Control

If the Software is provided through a private repository, private archive, private package, private registry, private container registry, or other restricted-access method, the Software must be treated as confidential.

Recipients must use reasonable technical, administrative, and organizational safeguards to prevent unauthorized access, use, copying, disclosure, distribution, or retention.

Recipients may not place the Software in public repositories, public package registries, public container registries, public documentation systems, public issue trackers, public paste sites, public file shares, public AI tools, public knowledge bases, or other public systems.

16. No AI Training or Model Use

You may not use the Software, source code, documentation, examples, comments, schemas, models, workflows, or related materials to train, fine-tune, evaluate, benchmark, improve, or develop any artificial intelligence model, machine learning model, code-generation system, code-analysis system, commercial assistant, migration assistant, firewall automation assistant, or security automation assistant without prior written permission from the Licensor.

You may not submit the Software or any portion of it to third-party AI tools or hosted code assistants in a way that permits retention, training, indexing, reuse, or disclosure.

17. No Implied Rights

No permission is implied by access, possession, silence, failure to object, prior conduct, prior authorization, course of dealing, business relationship, employment relationship, repository access, operational dependency, emergency use, or technical ability to copy or execute the Software.

All rights not expressly granted are reserved by the Licensor.

18. Written Permission Required

Any permission, waiver, exception, commercial license, enterprise license, company license, service authorization, third-party usage right, continued-use right, or special authorization must be granted in writing by the Licensor.

Verbal permission is not sufficient.

19. Termination

Any violation of this License automatically terminates all rights granted to you.

Upon termination, you must immediately stop using the Software and delete or return all copies in your possession or control, including source code, object code, forks, local clones, backups, build artifacts, container images, deployment artifacts, documentation, internal packages, modified versions, and derivative materials.

Upon request, you must certify in writing that deletion or return has been completed.

20. Revocation

The Licensor may revoke permission to use the Software at any time unless a separate written agreement signed by the Licensor states otherwise.

After revocation, all use must cease and all copies must be deleted or returned as directed by the Licensor.

21. No Warranty

THE SOFTWARE IS PROVIDED “AS IS,” “AS AVAILABLE,” AND “WITH ALL FAULTS.”

USE OF THE SOFTWARE IS ENTIRELY AT YOUR OWN RISK.

THE LICENSOR MAKES NO WARRANTIES OF ANY KIND, WHETHER EXPRESS, IMPLIED, STATUTORY, OR OTHERWISE, INCLUDING BUT NOT LIMITED TO WARRANTIES OF MERCHANTABILITY, FITNESS FOR A PARTICULAR PURPOSE, TITLE, NON-INFRINGEMENT, ACCURACY, SECURITY, RELIABILITY, AVAILABILITY, COMPATIBILITY, PERFORMANCE, ERROR-FREE OPERATION, OR THAT THE SOFTWARE WILL MEET YOUR REQUIREMENTS.

THE LICENSOR DOES NOT WARRANT THAT THE SOFTWARE WILL CONFIGURE FIREWALLS CORRECTLY, MIGRATE CONFIGURATIONS CORRECTLY, GENERATE VALID POLICIES, PRESERVE SECURITY POSTURE, PREVENT MISCONFIGURATION, PREVENT OUTAGES, PREVENT SECURITY INCIDENTS, OR OPERATE WITHOUT ERROR.

YOU ARE SOLELY RESPONSIBLE FOR REVIEWING, TESTING, VALIDATING, APPROVING, DEPLOYING, MONITORING, AND MAINTAINING ANY CONFIGURATION, POLICY, OBJECT, RULE, SCRIPT, MIGRATION OUTPUT, API REQUEST, OR OTHER OUTPUT CREATED, MODIFIED, OR AFFECTED BY THE SOFTWARE.

22. Limitation of Liability

TO THE MAXIMUM EXTENT PERMITTED BY LAW, THE LICENSOR SHALL NOT BE LIABLE FOR ANY CLAIM, DAMAGE, LOSS, LIABILITY, COST, EXPENSE, OR OTHER HARM ARISING FROM OR RELATED TO THE SOFTWARE, THE USE OF THE SOFTWARE, THE INABILITY TO USE THE SOFTWARE, OR ANY OUTPUT CREATED, MODIFIED, OR AFFECTED BY THE SOFTWARE.

THIS INCLUDES, WITHOUT LIMITATION, ANY DIRECT, INDIRECT, INCIDENTAL, CONSEQUENTIAL, SPECIAL, EXEMPLARY, PUNITIVE, RELIANCE, COVER, BUSINESS INTERRUPTION, OR SIMILAR DAMAGES.

THIS ALSO INCLUDES, WITHOUT LIMITATION, LOST PROFITS, LOST REVENUE, LOST BUSINESS OPPORTUNITIES, LOSS OF GOODWILL, LOST DATA, CORRUPTED DATA, SECURITY INCIDENTS, FIREWALL OUTAGES, NETWORK OUTAGES, NETWORK DISRUPTIONS, MISCONFIGURATIONS, POLICY ERRORS, ROUTING ERRORS, NAT ERRORS, VPN ERRORS, OBJECT ERRORS, ACCESS CONTROL ERRORS, MIGRATION FAILURES, DEPLOYMENT FAILURES, COMPLIANCE FAILURES, REGULATORY ISSUES, CUSTOMER CLAIMS, THIRD-PARTY CLAIMS, INCIDENT RESPONSE COSTS, RECOVERY COSTS, REMEDIATION COSTS, OR OPERATIONAL DOWNTIME.

THE LICENSOR’S TOTAL CUMULATIVE LIABILITY FOR ALL CLAIMS ARISING FROM OR RELATED TO THE SOFTWARE SHALL BE ZERO DOLLARS ($0), OR THE MINIMUM LIABILITY AMOUNT REQUIRED BY APPLICABLE LAW, WHICHEVER IS GREATER.

23. Indemnification

You agree to defend, indemnify, and hold harmless the Licensor from and against any claims, damages, liabilities, losses, costs, expenses, attorneys’ fees, and demands arising from or related to your use, misuse, unauthorized use, distribution, disclosure, modification, commercialization, hosting, service use, or violation of this License.

24. Export, Compliance, and Restricted Use

You are responsible for complying with all applicable laws, regulations, sanctions, export-control rules, cybersecurity regulations, data-protection laws, employment obligations, confidentiality obligations, and contractual restrictions.

You may not use the Software where such use would violate law, contract, regulation, export restrictions, sanctions, or third-party rights.

25. Severability

If any provision of this License is found unenforceable, invalid, or unlawful, the remaining provisions shall remain in full force and effect.

The unenforceable provision shall be modified to the minimum extent necessary to make it enforceable while preserving the Licensor’s intent as closely as possible.

26. No Waiver

Failure by the Licensor to enforce any provision of this License does not waive the Licensor’s right to enforce that provision or any other provision later.

A waiver must be written and signed by the Licensor.
...
This License is the entire agreement governing access to and use of the Software unless replaced or supplemented by a separate written agreement signed by the Licensor.
